    ...
    public class d : ContentPage
    {
        ...
        public d(string startpage, String Titles, String BGColor)
        {
            ...
            sp = startpage;
                ...
                pages.Add(new Pages { title = "Categories of abuse", description = "<h3 style='color:#953735'>Domestic Abuse</h3> Psychological, physical, sexual, financial, emotional abuse and so called 'honour based' abuse.", id = "4",yesbutton="2", yesnext="17" });
                pages.Add(new Pages { title = "Categories of abuse", description = "<h3 style='color:#953735'>Sexual abuse</h3> Include rape, indecent exposure, sexual harassment, inappropriate looking or touching, sexual teasing or innuendo, sexual photography, subjection to pornography or witnessing sexual acts, sexual assault or sexual acts to which the adult has not consented or was pressured into consenting.", id = "5", yesbutton = "2", nobutton = "2", yesnext = "17", nonext = "8" });
                ...
                pages.Add(new Pages { title = "Categories of abuse", description = "<h3 style='color:#953735'>Discriminatory abuse </h3>Includes forms of harassment, slurs or similar treatment because of race, gender and gender identity, age, disability, sexual orientation or religion.", id = "9", yesbutton = "2", nobutton = "2", yesnext = "17", nonext = "12" });
                pages.Add(new Pages { title = "Categories of abuse", description = "<h3 style='color:#953735'>Organisational abuse </h3>Includes neglect and poor practice within an institution or specific care setting such as a hospital or care home, or in relation to care provided in one's own home. This may range from one off incidents to ongoing ill-treatment. It can be through neglect or poor professional practice as a result of the structure, policies, processes and practices within an organisation.", id = "10" ,yesbutton="2",yesnext="17"});
                pages.Add(new Pages { title = "Categories of abuse", description = "<h3 style='color:#953735'>Neglect and acts of omission</h3> Includes ignoring medical, emotional or physical care needs, failure to provide access to appropriate care and support or educational services, withholding the necessities of life such as medication, adequate nutrition and heating.", id = "11", yesbutton = "2", nobutton = "1", yesnext = "17", nonext = "14" });
                pages.Add(new Pages { title = "Categories of abuse", description = "<h3 style='color:#953735'>Self-neglect</h3> This covers a wide range of behaviour such as neglecting to care for one's personal hygiene, health or surroundings and includes behaviours such as hoarding. <p> *For more advice on hoarding - contact your local District Borough Council", id = "12", yesbutton = "2", yesnext = "17" });
            ...
            string     printout = "";
                foreach (var p in pages)
                {
                    ...
                    if (startpage == "3") { App.app_title = "Categories of Abuse"; };
                    if (startpage == "4") { App.app_title = "Categories of Abuse"; };
                    if (startpage == "5") { App.app_title = "Categories of Abuse"; };
                    if (startpage == "6") { App.app_title = "Categories of Abuse"; };
                    if (startpage == "7") { App.app_title = "Categories of Abuse"; };
                    if (startpage == "8") { App.app_title = "Categories of Abuse"; };
                    if (startpage == "9") { App.app_title = "Categories of Abuse"; };
                    if (startpage == "10") { App.app_title = "Categories of Abuse"; };
                    if (startpage == "11") { App.app_title = "Categories of Abuse"; };
                    if (startpage == "12") { App.app_title = "Categories of Abuse"; };
            ...
            htmlSource.Html = "<HTML><style>margin:5px;</style><body style='margin:10px'><div style='background-color:white;width=100%;font-size:18px;font-family:calibri;color:#878787'>" + printout + "</div><div width=100%;'></body></html>";

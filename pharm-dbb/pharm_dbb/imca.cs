...

{
    ...
    public class iSAFA : CarouselPage
    {
        ...
        public iSAFA(String info)
        {
            ...
            l5.IsEnabled = true;
                  ...
                  a =  "An Independent Mental Capacity Advocate (ISAFA) must be instructed when the person is found to lack capacity and a best interest decision is needed and the person has no appropriate person (friends or family) to consult on the following decisions:< ul >< li > Serious medical treatment</ li > < li > A change of accommodation </ li ></ ul > ";
                 b= "In addition, there is a duty in the NHS and social care settings to consider requesting an ISAFA in the following circumstances:<ul >< li > Safeguarding Adults from Abuse </ li > < li > Care Reviews </ li ></ ul > ";
                 c = "The ISAFA’s role in these circumstances is to:< ul >< li > Gather  the views and beliefs of person</ li >< li > Evaluate all the relevant information</ li >< li > Provide a written report to assist the decision maker (e.g.Doctor) </ li ></ ul > ";
                d= "If you need to instruct an ISAFA please contact the Hertfordshire service (POhWER) via:< p > Email - pohwer@pohwer.net <p> Webpage - < a href = 'http://www.pohwer.net/index-13.html' > (POhWER) </ a > < p> Phone - 0300 456 2370";
